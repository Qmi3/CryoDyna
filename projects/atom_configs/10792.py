dataset_attr = dict(
    ...
    starfile_path="/lustre/grp/gyqlab/share/cryoem_particles/10792/data/join_particles.star",
    apix=1.16,
    side_shape=288,
    ref_pdb_path="/lustre/grp/gyqlab/share/cryoem_particles/10792/data/7pjv_centered_clean.pdb",
)
