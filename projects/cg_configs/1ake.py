...
dataset_attr = dict(
    ...
    # dataset_dir=
    # '/lustre/grp/gyqlab/share/cryoem_particles/tutorial_data_1ake/uniform_snr0-0001_ctf',
    # starfile_path=
    # '/lustre/grp/gyqlab/share/cryoem_particles/tutorial_data_1ake/uniform_snr0-0001_ctf/simulation.star',
    apix=1.0,
    side_shape=128,
    ref_pdb_path="projects/struct_prior/1akeA_50/1akeA_50.pdb",
    ref_cg_pdb_path="projects/struct_prior/1akeA_50/1akeA_50_cg.pdb",
)
